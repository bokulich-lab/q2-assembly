...
def _map_sample_reads(
        common_args: list, paired: bool, sample_name: str,
        sample_inputs: dict, result_fp: str
):
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        shutil.move(bam_result,
                    os.path.join(result_fp, f'{sample_name}_alignment.bam'))
...
def _gather_sample_data(
        indexed_contigs: Bowtie2IndexDirFmt, reads_manifest: pd.DataFrame,
        paired: bool
):
