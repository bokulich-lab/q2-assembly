...
from .._utils import (_construct_param, _process_common_input_params,
                      _remove_html_element, _modify_links)
...
class TestUtils(TestPluginBase):
    ...
    def test_remove_html_element_existing(self):
        ...
        exp_fp = self.get_data_path(
            'html-files/sample-report-div-removed.html')
    ...
    def test_modify_links(self):
        ...
        exp_fp = self.get_data_path(
            'html-files/sample-report-links-updated.html')
        self.assertHTMLEqual(fp_out, exp_fp)
    ...
    def test_fix_html_reports(self):
        ...
        self.assertHTMLEqual(f'{self._tmp}/report.html',
                             f'{self._tmp}/expected/report.html')
