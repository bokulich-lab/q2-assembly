...
from q2_assembly._action_params import (
    ...
    quast_params, quast_param_descriptions,
    iss_params, iss_param_descriptions
)
...
plugin.methods.register_function(
    ...
    input_descriptions={
        'indexed_contigs': 'Bowtie 2 indices generated for contigs '
                           'of interest.',
    ...
    output_descriptions={
        'alignment_map': 'Reads-to-contigs mapping.'
    },
